...
import immersive_trains.entity.bullet.BulletEntity;
import immersive_trains.entity.bullet.TinyTNT;
...
public interface Entities {
    ...
    Supplier<EntityType<TrainEntity>> TRAIN = register("train", EntityType.Builder
            .of(TrainEntity::new, MobCategory.MISC)
            .sized(1.75f, 0.85f)
            .clientTrackingRange(12)
            .fireImmune()
    );
