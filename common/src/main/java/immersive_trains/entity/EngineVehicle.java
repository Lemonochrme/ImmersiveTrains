...
import immersive_trains.network.c2s.EnginePowerMessage;
                ...
                if (getControllingPassenger() instanceof ServerPlayer player) {
                    ...
                    if (utilization > 0 && isFuelLow()) {
                        if (lastFuelState != FuelState.LOW) {
                            player.displayClientMessage(Component.translatable("immersive_trains." + getFuelType() + ".low"), true);
                        ...
                        if (lastFuelState != FuelState.EMPTY) {
                            player.displayClientMessage(Component.translatable("immersive_trains." + getFuelType() + "." + (lastFuelState == FuelState.FUELED ? "out" : "none")), true);
