...
import immersive_trains.item.upgrade.VehicleUpgrade;
import immersive_trains.item.upgrade.VehicleUpgradeRegistry;
import immersive_trains.mixin.ServerPlayerEntityMixin;
import immersive_trains.network.s2c.OpenGuiRequest;
import immersive_trains.screen.VehicleScreenHandler;
