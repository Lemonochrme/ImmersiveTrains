package immersive_trains.config;

import immersive_trains.Main;
import immersive_trains.config.configEntries.BooleanConfigEntry;
import immersive_trains.config.configEntries.FloatConfigEntry;
import immersive_trains.config.configEntries.IntegerConfigEntry;
